def check_pw(number) :
    ...
    is_incrementing, has_double, has_triple = True, False, False
    last_character = num_string[0]
    for char in num_string[1:] :
        has_double = has_double or char == last_character
        is_incrementing = is_incrementing and char >= last_character
        last_character = char
    return is_incrementing and has_double and not has_triple
